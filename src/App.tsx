...
function App() {
  return (
    <Root>
      {/* <Header>
        <Text style={{ flex: 1, minWidth: "fit-content" }}>
          📍NYC / Amsterdam / London
        </Text>
      ...
      <Body>
        <Column style={{ flex: 1 }} mainAxisSize="stretch" crossAxisSize="max">
          <Window title="About me" background={background0}>
            <Text>
              3 playful speculative objects, happy accidents, geometric
              patterns, grid systems, learning about cultures & kind people. I
              enjoy thinking about new ways to make, but equally if not more
              enjoy applying ideas to the real world.
            </Text>
            <SizedBox height={18} />
            <Window
              style={{ height: 270 }}
